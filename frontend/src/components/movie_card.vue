          ...
          <div class="row">
            <div class="col">
              <div class="row">
                ...
                <div class="col me-2">{{ number_of_watches }}</div>
              </div>

            </div>
            <div class="col border-start border-2 border-dark">
              <div class="row">
                <div class="col ms-1">
                ...
                <div class="col me-2">{{ number_of_favorites }}</div>
              </div>
            </div>
          </div>
        </div>
...
<script>
export default {
  props: ['id', 'poster', 'title', 'date', 'rating', 'genre', 'length', 'number_of_watches', 'number_of_favorites'],
  data() {
    return {}
  }
}
