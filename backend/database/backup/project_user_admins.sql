...
CREATE TABLE `user_admins` (
  ...
  PRIMARY KEY (`user_id`),
  CONSTRAINT `user_admins_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `user_admins` VALUES (22,'Admin'),(26,'Admin');
...
-- Dump completed on 2023-01-10 23:20:08
